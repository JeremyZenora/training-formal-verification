...
contract MathMastersTest is Base_Test {
    ...
    function halmos_testMulWadUpFuzz(uint256 x, uint256 y) public pure {
    ...
    function testFuzzTopHalfs() public {
        CompactCodeBase cc = new CompactCodeBase();
        assertEq(cc.solmateTopHalf(5708979305937057533693458332192636400795601600), cc.mathMastersTopHalf(x));
    }
